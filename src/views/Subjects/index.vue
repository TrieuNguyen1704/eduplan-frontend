<template>
  <div class="min-h-screen bg-slate-50 p-6 md:p-10">
    <div class="max-w-5xl mx-auto">
      ...
      <div v-else-if="subjects.length === 0" class="bg-white rounded-2xl p-12 text-center border border-slate-100 shadow-sm">
        ...
        >
          <div class="flex justify-between items-start mb-4">
            ...
            <button 
              ...
              class="text-slate-300 hover:text-red-500 transition px-2 py-1"
              title="Xóa môn học"
            >
              ✕
            </button>
          ...
          <p class="text-sm text-slate-400 font-medium">Số tín chỉ: <span class="text-slate-600">{{ sub.credits }}</span></p>
        </div>
      </div>
...
// Cấu hình Axios tự động gắn Token
